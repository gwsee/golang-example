...
func newPet(db *gorm.DB, opts ...gen.DOOption) pet {
	...
	_pet.ID = field.NewInt(tableName, "id")
	...
	_pet.UserID = field.NewInt(tableName, "user_id")
...
type IPetDo interface {
	...
	Unscoped() IPetDo
	Create(values ...*model.Pet) error
	CreateInBatches(values []*model.Pet, batchSize int) error
	Save(values ...*model.Pet) error
	First() (*model.Pet, error)
	Take() (*model.Pet, error)
	Last() (*model.Pet, error)
	Find() ([]*model.Pet, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Pet, err error)
	FindInBatches(result *[]*model.Pet, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Pet) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Pet, error)
	FirstOrCreate() (*model.Pet, error)
	FindByPage(offset int, limit int) (result []*model.Pet, count int64, err error)
