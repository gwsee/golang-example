...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.ManagerID = field.NewInt(tableName, "manager_id")
	_user.Active = field.NewInt8(tableName, "active")
...
func (u *user) updateTableName(table string) *user {
	...
	u.ManagerID = field.NewInt(table, "manager_id")
	u.Active = field.NewInt8(table, "active")
